...
public class FlashlightInteractable_xr : MonoBehaviour
{
    ...
    {
        if (hasActivatedKey || paintingTarget == null || flashlightLight == null || !flashlightLight.enabled)
            return;
        ...
        if (distance <= activationDistance)
        {
            if (hiddenKey != null)
            {
                hiddenKey.SetActive(true); // 显示隐藏物体
