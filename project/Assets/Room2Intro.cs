...
public class Room2Intro : MonoBehaviour
{
    [Header("字幕设置")]
    ...
    void Start()
    {
        ...
        // 检查场景名称
        if (!SceneManager.GetActiveScene().name.Equals("Room2", System.StringComparison.OrdinalIgnoreCase))
        {
            Debug.LogWarning("[Room1Intro] 当前不是 Room2 场景，禁用音频播放");
